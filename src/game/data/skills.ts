...
export const SKILLS: Skill[] = [
  createSkill('atk_1', '力量训练I', '💪', '攻击力+2.5/级', 1, 1, [], 5),
  createSkill('atk_2', '力量训练II', '💪', '攻击力+5/级', 3, 20, ['atk_1'], 5),
  createSkill('atk_3', '力量训练III', '💪', '攻击力+11/级', 5, 50, ['atk_2'], 5),
  createSkill('atk_4', '狂暴之力', '🔥', '攻击力+22/级', 8, 80, ['atk_3'], 5),
  createSkill('atk_5', '战神附体', '⚔️', '攻击力+35/级', 12, 120, ['atk_4'], 5),

  createSkill('spd_1', '敏捷训练I', '👟', '攻速+2%/级', 1, 1, [], 5),
  createSkill('spd_2', '敏捷训练II', '👟', '攻速+2.8%/级', 3, 20, ['spd_1'], 5),
  createSkill('spd_3', '疾风步', '💨', '攻速+3.2%/级', 5, 50, ['spd_2'], 5),
  createSkill('spd_5', '时间加速', '⏱️', '攻速+6%/级', 8, 80, ['spd_3'], 5),

  createSkill('rng_4', '鹰眼视野', '🦅', '射程+80/级', 5, 50, [], 5),

  createSkill('crit_1', '暴击入门I', '💥', '暴击率+1%/级', 1, 2, [], 5),
  createSkill('crit_2', '暴击入门II', '💥', '暴击率+2.2%/级', 3, 20, ['crit_1'], 5),
  createSkill('crit_3', '致命一击', '☠️', '暴击率+4.5%/级', 5, 50, ['crit_2'], 5),
  createSkill('crit_4', '死神之触', '💀', '暴击率+7.5%/级', 8, 80, ['crit_3'], 5),

  createSkill('cdmg_1', '暴击伤害I', '⚔️', '暴击伤害+8%/级', 3, 20, ['crit_1'], 5),
  createSkill('cdmg_2', '暴击伤害II', '⚔️', '暴击伤害+20%/级', 5, 50, ['cdmg_1', 'crit_2'], 5),
  createSkill('cdmg_3', '毁天灭地', '💫', '暴击伤害+45%/级', 10, 150, ['cdmg_2', 'crit_3'], 5),

  createSkill('hp_1', '生命强化I', '❤️', '最大生命+25/级', 1, 1, [], 5),
  createSkill('hp_2', '生命强化II', '❤️', '最大生命+55/级', 3, 20, ['hp_1'], 5),
  createSkill('hp_3', '生命强化III', '❤️', '最大生命+90/级', 5, 50, ['hp_2'], 5),
  createSkill('hp_4', '不灭之躯', '💖', '最大生命+160/级', 8, 80, ['hp_3'], 5),

  createSkill('def_1', '防御训练I', '🛡️', '减伤+2.5%/级', 1, 2, [], 5),
  createSkill('def_2', '防御训练II', '🛡️', '减伤+5%/级', 3, 20, ['def_1'], 5),
  createSkill('def_3', '铁壁', '🏰', '减伤+9%/级', 5, 50, ['def_2'], 5),
  createSkill('def_4', '金刚不坏', '🔷', '减伤+15%/级', 8, 80, ['def_3'], 5),

  createSkill('regen_1', '生命恢复I', '💚', '每秒恢复0.8%生命', 3, 20, ['hp_1'], 5),
  createSkill('regen_2', '生命恢复II', '💚', '每秒恢复1.5%生命', 5, 50, ['regen_1', 'hp_2'], 5),
  createSkill('regen_3', '生命涌动', '🌿', '每秒恢复2.5%生命', 8, 80, ['regen_2', 'hp_3'], 5),

  createSkill('magnet_1', '磁力装置', '🧲', '拾取范围+100', 1, 2, [], 5),

  createSkill('gold_1', '财富嗅觉', '💰', '金币掉落+22%', 3, 20, [], 5),
  createSkill('gold_2', '寻宝达人', '💎', '金币掉落+55%', 5, 50, ['gold_1'], 5),

  createSkill('exp_1', '学习能力', '📚', '经验获取+12%', 3, 20, [], 5),
  createSkill('exp_2', '学霸', '🎓', '经验获取+30%', 5, 50, ['exp_1'], 5),

  createSkill('drop_1', '幸运儿', '🍀', '物品掉率+10%', 3, 20, [], 5),
  createSkill('drop_2', '欧皇附体', '👑', '物品掉率+25%', 5, 50, ['drop_1'], 5),

  createSkill('lightning_1', '雷霆射击', '⚡', '攻击有2%概率触发感电，伤害链2个敌人', 5, 50, ['spd_1'], 5),
  createSkill('lightning_2', '万雷天牢', '🌩️', '攻击有3.5%概率触发感电，伤害链3个敌人', 8, 80, ['lightning_1', 'spd_2'], 5),

  createSkill('lifesteal_1', '吸血打击', '🩸', '攻击回复0.3%最大生命', 3, 20, ['hp_1'], 5),
  createSkill('lifesteal_2', '嗜血狂魔', '🔮', '攻击回复0.8%最大生命', 5, 50, ['lifesteal_1', 'hp_2'], 5),

  createSkill('piercing_2', '穿云箭', '🌪️', '子弹穿透4个敌人', 5, 50, [], 5),
...
export const FX_SKILL_TREE_LAYERS: string[][] = [
  ...
  ['fx_burn_1', 'fx_laser_1', 'fx_grenade_1'],
  ['fx_flash_1'],
];
